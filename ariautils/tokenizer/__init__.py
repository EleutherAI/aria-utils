...
class Tokenizer:
    ...
    def __init__(
        ...
        self.name: str = ""
        self.return_tensors = return_tensors  # DELETE
    ...
    def _detokenize_midi_dict(self, tokenized_seq: list[int]) -> MidiDict:
    ...
    def detokenize(self, tokenized_seq: list[int], **kwargs: Any) -> MidiDict:
